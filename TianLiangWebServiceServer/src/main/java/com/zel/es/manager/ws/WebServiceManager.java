...
import com.zel.impl.ws.config.EsSystemServiceImpl;
import com.zel.impl.ws.es.index.EsIndexServiceImpl;
import com.zel.impl.ws.es.search.EsSearchServiceImpl;
import com.zel.impl.ws.nlp.NlpServiceImpl;
import com.zel.impl.ws.test.TestServiceImpl;
...
public class WebServiceManager {
	...
	public void startWebService() {
		...
		String address = StaticValue.prefix_http
				+ SystemParas.es_search_server_ip + ":"
				+ SystemParas.es_search_server_port + "/";// 绑定的地址
		int count = 0;
	...
	public static void getWSClass4All(List<ServiceNameAndPathComp> wsCompList) {
		addOneWs(EsSearchServiceImpl.class, wsCompList);
		addOneWs(EsIndexServiceImpl.class, wsCompList);
		addOneWs(EsSystemServiceImpl.class, wsCompList);
		addOneWs(NlpServiceImpl.class, wsCompList);
		addOneWs(TestServiceImpl.class, wsCompList);
	}
